<?php
/**
 * Fichier gérant l'installation et désinstallation du plugin API Mailqueue
 *
 * @plugin     API Mailqueue
 * @copyright  2014
 * @author     Vertige (Didier)
 * @licence    GNU/GPL
 * @package    SPIP\Mailqueue\Installation
 */
...
/**
 * Fonction d'installation et de mise à jour du plugin API Mailqueue.
 *
 * Vous pouvez :
 *
 ...
 * @return void
**/
function mailqueue_upgrade($nom_meta_base_version, $version_cible) {
	$maj = array();
	# quelques exemples
	...
	#	array('ecrire_config', array('mailqueue', array('exemple' => "Texte de l'exemple")))
	#);
	#
...
/**
 * Fonction de désinstallation du plugin API Mailqueue.
 * 
 * Vous devez :
 *
 ...
 * @return void
**/
function mailqueue_vider_tables($nom_meta_base_version) {
	# quelques exemples
	# (que vous pouvez supprimer !)
